...
int main(void)
{
	...
	int* arraySubtraction(int *, int *, int);
	...
	result = arraySubtraction(arrayOne, arrayTwo, numberOfElements);
...
int *arraySubtraction(int *arrayOne, int *arrayTwo, int numberOfElements)
{
